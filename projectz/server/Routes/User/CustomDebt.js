...
router.post('/create', async (req, res) => {
    ...
    const debtCollection = client.db('test').collection('customdebtmodels');
    ...
    const amountLeftOver = req.body.amountLeftOver;
    const percentOfIncome = req.body.percentOfIncome
    const userId = req.body.userId;
    const payedOff = req.body.isPayedOff
    
    const newDebt = new CustomDebtModel({creditorName: creditorName, originalDebtAmount: originallDebtAmount, currentDebtAmount: currentDebtAmount, amountLeftOver: amountLeftOver, percentOfIncome: percentOfIncome, userId: userId, isPayedOff: payedOff})
    console.log(newDebt)
...
router.post('/update', async (req, res) => {
    ...
    const debtCollection = db.collection("customdebtmodels");
    ...
    const newDebt = new DebtModel({ creditorName: creditorName, originalDebtAmount: originallDebtAmount, currentDebtAmount: currentDebtAmount, intrestRate: intrestRate, originalMinumnPayment: originalMinumnPayment, originallDebtAmount: originallDebtAmount, minumnPayment: minumnPayment, userId: userId, dueDate: dueDate })
